...
class Map:
    ...
    def plot_settings(self):
        ...
        self.bus_color = ["r", (230.0 / 255, 152.0 / 255, 0), "g"]
        ...
        self.line_lw = [1, 1, 1]
        self.line_color = ["r", (230.0 / 255, 152.0 / 255, 0), "g"]
        ...
        self.info_fc = [213.0 / 255, 230.0 / 255, 1]  # color for info box
    ...
    def init_plot(self, fig_size=[13, 8], bidz_map=os.path.join("Data", "raw", "map_with_bidz2018.npz")):
        ...
        self.ax.fill([-1e6, -1e6, 2e6, 2e6, -1e6], [5e6, 9e6, 9e6, 5e6, 5e6], facecolor=(220.0 / 255, 238.0 / 255, 1))
    ...
    def add_topo(self):
        ...
        for s in np.unique(self.bus_set[self.bus_set >= 0]):
            ...
            self.segments_object.append(
                self.ax.plot(x, y, ms=lw**2, marker="o", ls="", c=c, zorder=10, label=label, picker=5, gid=gid)[0]
            )
    ...
    def add_legend(self):
        ...
        corners = arr(
            [
                ...
                [self.x_min, self.y_max],  # best corners for legend and colorbars
